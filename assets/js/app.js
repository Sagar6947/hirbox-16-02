...
! function (n) {
    ...
    n("#side-menu").metisMenu(), i(), e = document.body.getAttribute("data-sidebar-size"), n(window).on("load", function () {
            ...
            body.hasAttribute(!1) && l("topbar-color-light"), 1024 <= window.innerWidth && window.innerWidth <= 1366 && (document.body.setAttribute("data-sidebar-size", "sm"), l("sidebar-size-small"))
