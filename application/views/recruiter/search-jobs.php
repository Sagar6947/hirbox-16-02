...
<head>
    ...
    <meta charset="utf-8" />
    <title>Search Jobs | Hirebox</title>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0 font-size-18">Search Jobs</h4>
                        ...
                        <div class="col-12 mb-3">
                            <input type="search" class="form-control" aria-controls="datatable" placeholder="Search Jobs">
                        </div>
                    </div>
                    <!-- end page title -->
