                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 f-24">Applied Jobs</h4>
                                                            ...
                                                            <div class="post_detial d-flex border-top res-flex-column py-2">
                                                                <div class="company_detail d-flex align-items-center justify-content-between w-100">
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <a href="<?= base_url('candidate/view_job_details/' . $job_post['job_id'] . '/' . url_title($job_post['job_title'])) ?>" class="btn <?= ((!empty($applied_info) ? 'btn-success' : 'btn-primary')) ?> btn-primary text-white waves-effect waves-light"><?= ((!empty($applied_info) ? '<i class="fa fa-check"></i> Applied' : '<i class="fa fa-check"></i>Apply')) ?></a>
                                                                    </div>
                                                                </div>
                                                            </div>
